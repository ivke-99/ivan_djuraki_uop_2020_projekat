			...
			public void actionPerformed(ActionEvent e) {
				...
				if (opcija != 1 ) {
					...
					if(txtIme.getText().isEmpty() || txtPrezime.getText().isEmpty()
							...
							|| txtLozinka.getText().isEmpty() || txtPlata.getText().isEmpty() || cbAdmin.getSelectedIndex() == -1)
						{
...
public void IzmeniAdmina(Admin old,JFormattedTextField txtBrojTelefona,JComboBox cbPol) throws Exception {
