	...
	public IzmeniAutomobilPage() throws ParseException {
		...
		btnIzmeni.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (!(opcija == false)) {
					if(cbAuto.getSelectedIndex() == -1 || cbMusterija.getSelectedIndex() == -1 ||cbTipGoriva.getSelectedIndex() == -1 ||
...
public void IzmeniAuto(Automobil old,JFormattedTextField txtGodiste,JTextField txtSnaga,JTextField txtKubikaza) throws Exception {
